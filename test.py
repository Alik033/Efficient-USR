...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='UIE_USR248_X2_V1',
    ...
    # test
    parser.add_argument('-t', '--test_script_name', type=str, default='tester_uie')
    parser.add_argument('-b', '--batch_size', type=int, default=1)
    parser.add_argument('-n', '--node_ip', type=str, default='localhost') 

    parser.add_argument('--test_dataset_name', type=str, default='UFO120', 
                choices=['USR248', 'UFO120', "Custom"])
...
def main():
    ...
    data_key = config.test_dataset_name
